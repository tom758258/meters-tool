...
class CorePublicApiTests(unittest.TestCase):
    def test_public_imports_are_available(self):
        imported = {
            ...
            "StartFeatureSupportScope": StartFeatureSupportScope,
            "StartWorkflowSupport": StartWorkflowSupport,
            "FEATURE_KIND_MEASUREMENT": FEATURE_KIND_MEASUREMENT,
            "FEATURE_KIND_TRIGGER_MODE": FEATURE_KIND_TRIGGER_MODE,
            "SUPPORT_POLICY_MODE_PRODUCT": SUPPORT_POLICY_MODE_PRODUCT,
            "SUPPORT_POLICY_MODE_VALIDATION": SUPPORT_POLICY_MODE_VALIDATION,
            "VALIDATION_STATUS_FEATURE_PENDING": VALIDATION_STATUS_FEATURE_PENDING,
            ...
            "find_feature_support": find_feature_support,
            "normalize_support_feature_value": normalize_support_feature_value,
            "start_request_feature_requirements": start_request_feature_requirements,
            "start_workflow_support": start_workflow_support,
            "validate_start_workflow_support": validate_start_workflow_support,
            "validate_start_workflow_support_metadata": validate_start_workflow_support_metadata,
