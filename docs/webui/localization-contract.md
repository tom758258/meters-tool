...
| `_web_payloads.py` | 34460A pending | `LAN/TCPIP system-VISA validation`; `LAN/TCPIP pyvisa-py @py validation` | API presentation list | existing prose fallback plus positional semantic keys | `support.pending.*` | P2.5 |
