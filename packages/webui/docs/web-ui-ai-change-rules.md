...
- `packages/core/src/keysight_logger_core/acquisition.py`
- `packages/cli/src/keysight_logger_cli/cli.py`
- `packages/core/src/keysight_logger_core/instrument.py`
...
- Backend: FastAPI/Uvicorn in `packages/webui/src/keysight_logger_webui/web_ui.py`.
- Frontend: static HTML/CSS/JavaScript in `packages/webui/src/keysight_logger_webui/static/`.
- No Node build step.
